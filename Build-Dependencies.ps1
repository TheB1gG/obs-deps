...
function Package-Dependencies {
    ...
    switch ( $PackageName ) {
        ffmpeg {
            ...
            Get-ChildItem ./lib -Exclude 'librist.lib','zlibstatic.lib','srt.lib','libx264.lib','libx265.lib','mbed*.lib','everest.lib','p256m.lib','zlib.lib','datachannel.lib','cmake' | Remove-Item -Force -Recurse
